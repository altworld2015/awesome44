...
desktop_wibox02:geometry({ x = 1327, y = 600, width = 32, height = 32 })
...
desktop_wibox04:geometry({ x = 1299, y = 640, width = 90, height = 18 })
...
desktop_wibox9aa:geometry({ x = 1074, y = 601, width = 32, height = 32 })
...
function my_widget10aa:fit(context, width, height) return width, height end
local desktop_wibox10aa = wibox({ type = "desktop", visible = true, bg = "#00000000" })
desktop_wibox10aa:geometry({ x = 1068, y = 640, width = 70, height = 18 })
desktop_wibox10aa:set_widget(my_widget10aa)
----------------
...
desktop_wibox52:geometry({ x = 77, y = 877, width = 32, height = 32 })
